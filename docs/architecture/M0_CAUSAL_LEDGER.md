...
13. structural validation remains bounded rather than materializing arbitrary malformed metadata or schema collections, and similarly named user schema cannot be hidden by wildcard matching of SQLite's reserved prefix;
